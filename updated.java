    ...
    public static void main(String[] args) {
        ...
        char c = scnr.next().charAt(0);
            ...
            if (Character.isAlphabetic(c))
                continue;
            //Convert char to integer using ASCII value
           int aisleChoice = (int)c-'0';
            System.out.println();
            ...
            while (itemCount < maxItemsArray.length) {
                //Error checking for valid choice
                char choiceInput;
                do {
                    System.out.println("Enter item number to add to the shopping list (Enter 0 to finish aisle): ");
                    choiceInput = scnr.next().charAt(0);

                } while (Character.isAlphabetic(choiceInput));
                //Converting to integer
                int choice = (int)choiceInput-'0';
                ...
                if (itemCount == maxItemsArray.length) {
                    break; // Finish shopping if max items reached
                }
            }
        }
        ...
        double taxedTotalCost = tax + totalCost;
